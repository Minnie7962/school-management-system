...
class ExamRuleController extends Controller
{
    ...
    public function store(ExamRuleStoreRequest $request)
    {
        try {
            ...
            return response()->json(['status' => 'Exam rule creation was successful!']);
        } catch (\Exception $e) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'Exam rule update was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function destroy(ExamRule $examRule)
    {
        try {
            $examRule->delete();
            return response()->json(['status' => 'Exam rule deletion was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
