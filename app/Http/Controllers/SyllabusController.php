...
class SyllabusController extends Controller
{
    ...
    {
        return response()->view('syllabi.show', ['syllabus' => $syllabus]);
    }
    ...
    {
        return response()->view('syllabi.edit', ['syllabus' => $syllabus]);
    }
    ...
    public function destroy(Syllabus $syllabus)
    {
        try {
            $syllabus->delete();
            return response()->json(['status' => 'Syllabus deleted successfully!']);
        } catch (\Exception $e) {
