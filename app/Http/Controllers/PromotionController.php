...
class PromotionController extends Controller
{
    ...
    */
    ...
    public function index(Request $request)
    {
        ...
        return response()->view('promotions.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            return response()->view('promotions.promote', $data);
        } catch (\Exception $e) {
    ...
    {
        return response()->view('promotions.show', compact('promotion'));
    }
    ...
    {
        return response()->view('promotions.edit', compact('promotion'));
    }
