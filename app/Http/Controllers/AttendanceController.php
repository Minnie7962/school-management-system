...
class AttendanceController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            return response()->view('attendances.take', $data);
        } catch (\Exception $e) {
     ...
     *
     * @param  \App\Http\Requests\AttendanceStoreRequest  $request
     * @return \Illuminate\Http\RedirectResponse
     */
    ...
    public function show(Request $request)
    {
        ...
        try {
            ...
            return response()->view('attendances.view', $data);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function showStudentAttendance($id) {
        if(auth()->guard()->user()->role == "student" && auth()->guard()->user()->id != $id) {
            return abort(404);
        }
        $current_school_session_id = $this->getSchoolCurrentSession();
