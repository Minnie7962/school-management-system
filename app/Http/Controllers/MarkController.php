...
class MarkController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function storeFinalMark(Request $request): \Illuminate\Http\RedirectResponse {
        $current_school_session_id = $this->getSchoolCurrentSession();
    ...
    {
        return response()->view('marks.edit', ['mark' => $mark]);
    }
    ...
    public function update(Request $request, Mark $mark)
    {
        try {
            ...
            return response()->json(['status' => 'Mark updated successfully!']);
        } catch (\Exception $e) {
    ...
    public function destroy(Mark $mark)
    {
        try {
            $mark->delete();
            return response()->json(['status' => 'Mark deleted successfully!']);
        } catch (\Exception $e) {
            return response()->json(['error' => $e->getMessage()], 500);
        }
    }
