...
class RoutineController extends Controller
{
    ...
    {
        return response()->view('routines.index');
    }
    ...
    public function store(RoutineStoreRequest $request)
    {
        try {
            ...
            return response()->json(['status' => 'Routine save was successful!']);
        } catch (\Exception $e) {
    ...
    {
        return response()->view('routines.edit', ['routine' => $routine]);
    }
    ...
    public function update(Request $request, Routine $routine)
    {
        try {
            ...
            return response()->json(['status' => 'Routine update was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function destroy(Routine $routine)
    {
        try {
            $routine->delete();
            return response()->json(['status' => 'Routine deletion was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
