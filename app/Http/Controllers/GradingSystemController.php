...
class GradingSystemController extends Controller
{
    ...
    public function store(GradingSystemStoreRequest $request)
    {
        try {
            ...
            return response()->json(['status' => 'Creating grading system was successful!']);
        } catch (\Exception $e) {
    ...
    {
        return response()->json($gradingSystem);
    }
    ...
    public function edit(GradingSystem $gradingSystem)
    {
        ...
        return response()->view('exams.grade.edit', $data);
    }
    ...
    public function update(Request $request, GradingSystem $gradingSystem)
    {
        try {
            $gradingSystemRepository = new GradingSystemRepository();
            $gradingSystemRepository->update($gradingSystem, $request->validated());

            return response()->json(['status' => 'Updating grading system was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function destroy(GradingSystem $gradingSystem)
    {
        try {
            ...
            return response()->json(['status' => 'Deleting grading system was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
