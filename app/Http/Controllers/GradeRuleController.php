...
class GradeRuleController extends Controller
{
    ...
    public function store(GradeRuleStoreRequest $request)
    {
        try {
            ...
            return response()->json(['status' => 'Creating grading system rule was successful!']);
        } catch (\Exception $e) {
    ...
    {
        return response()->view('exams.grade.show-rule', compact('gradeRule'));
    }
    ...
    {
        return response()->view('exams.grade.edit-rule', compact('gradeRule'));
    }
    ...
    public function update(Request $request, GradeRule $gradeRule)
    {
        try {
            $gradeRuleRepository = new GradeRuleRepository();
            $gradeRuleRepository->update($gradeRule, $request->validated());

            return response()->json(['status' => 'Updating grading system rule was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function destroy(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'Deleting grading system rule was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
