...
class SectionController extends Controller
{
    ...
    */
    ...
    {
        $sections = $this->schoolSectionRepository->getAll();
        return response()->view('sections.index', compact('sections'));
    }
    ...
    {
        return response()->view('sections.create');
    }
    ...
    public function store(SectionStoreRequest $request)
    {
        try {
            ...
            return response()->json(['status' => 'Section creation was successful!']);
        } catch (\Exception $e) {
    ...
    {
        return response()->view('sections.show', compact('section'));
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            return response()->json(['status' => 'Section edit was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    {
        try {
            $this->schoolSectionRepository->delete($section->id);

            return response()->json(['status' => 'Section deletion was successful!']);
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
